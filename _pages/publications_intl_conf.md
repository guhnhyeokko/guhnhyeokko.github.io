...
description: International conference presentations in reversed chronological order
nav: false
---
...
<div class="publications">
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tbody>
        {% assign sorted_conferences = site.data.intl_conferences | sort: "year" | reverse %}
